...
def load_settings() -> Settings:
    ...
    LOG.debug(f"Settings loaded: modbus={settings.modbus_host}:{settings.modbus_port}, mqtt={settings.mqtt_host}:{settings.mqtt_port}, poll_interval={settings.poll_interval_seconds}s, reconnect_delay={settings.reconnect_delay_seconds}s")
    return settings